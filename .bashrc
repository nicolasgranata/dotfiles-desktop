...
alias hyprconfig="code $HOME/.config/hypr/hyprland.conf"

# --- Configuración de NVM (Node Version Manager) ---

export NVM_DIR="$HOME/.nvm"
[ -s "$NVM_DIR/nvm.sh" ] && \. "$NVM_DIR/nvm.sh"  # Carga nvm
[ -s "$NVM_DIR/bash_completion" ] && \. "$NVM_DIR/bash_completion"  # Carga la autocompletación de bash para nvm

# --- Fin de Configuración de NVM ---
